...
- 📊 **Dynamic Visualization**: Interactive Donut Charts and Dual Line Trend Graphs for deep spending analysis.
- 🌓 **Designer Themes**: Custom Light (Parchment & Sage) and Dark (Designer Modern) themes with high-contrast "pop" highlights.
- 🖋️ **Premium Typography**: Fully integrated with the **FUNGIS** custom font family for a unique, high-end character.
...
- **State**: Reducer Pattern + AsyncStorage
- **Charts**: Custom SVG-based visualization
- **Icons**: Untitled UI SVG system
...
- Clean, minimal layout with refined spacing and premium typography.
...
3. **🛑 Troubleshooting Logo Caching**:
   If the app logo doesn't update after replacement, run:
   ```bash
   npx expo start --clear
   ```
   And clear the cache of the **Expo Go** app on your phone.

---
*Developed by Abhiram Kasturi*
